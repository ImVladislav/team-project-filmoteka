 ...
 * limitations under the License.
 */
const I="firebase-heartbeat-store";let T=null;function S(){return T||(T=(0,a.openDB)("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(I)}}).catch((e=>{throw _.create("idb-open",{originalErrorMessage:e.message})}))),T}async function N(e,t){var n;try{const n=(await S()).transaction(I,"readwrite"),i=n.objectStore(I);return await i.put(t,R(e)),n.done}catch(e){if(e instanceof s.FirebaseError)d.warn(e.message);else{const t=_.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});d.warn(t.message)}}}function R(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */or=i.SDK_VERSION,d=or,(0,i._registerComponent)(new(0,r.Component)("database",((e,{instanceIdentifier:t})=>tr(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),(0,i.registerVersion)(c,u,rr),(0,i.registerVersion)(c,u,"esm2017")})),o("kyEFX").register(JSON.parse('{"5fZck":"index.d32fe421.js","45HKR":"coming_soon.265f69e2.jpg","9v6fF":"symbol-defs.5c2ad578.svg","4bOEk":"poster-modal-plug-desktop.fd8c97a1.jpg","lex4W":"iryna-bodnaryuk.bbf051c8.jpg","hX4l8":"vladyslav-gladyshko.e078bebf.jpg","1SX62":"yuriy_kulinichenko.e933625b.jpg","3Pm6E":"aleksandr-kurzhiy.4dfb5809.jpg","jJ9bP":"andrey-dymov.a61bb4c5.jpg","1BO4e":"rustem-dzhuraiev.5ae846f9.jpg","9xbrc":"vladislav-zavertaylo.96be176b.jpg","ibi2F":"vladyslav.b21ae48c.jpg","m09zo":"roman-tunkiv.8722f996.jpg","kqDX1":"serhiy-nazarov.8f39fd73.jpg"}'));
//# sourceMappingURL=index.d32fe421.js.map
